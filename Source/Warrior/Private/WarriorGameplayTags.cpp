...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_PickUp_Potion,"InputTag.PickUp.Potion");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_PickUp_Potion,"Player.Ability.PickUp.Potion");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_ConsumePotion,"Player.Event.ConsumePotion");
