	...
	if (!CharacterStartUpData.IsNull())
	{
		...
		{	
			...
			if (AWarriorBaseGameMode* BaseGameMode = GetWorld()->GetAuthGameMode<AWarriorBaseGameMode>())
			{
				...
				case EWarriorGameDifficulty::Challenge:
					AbilityApplyLevel = 1;
					break;
...
void AWarriorHeroCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	WarriorInputComponent->BindNativeInputAction(InputConfigDataAsset,WarriorGameplayTags::InputTag_PickUp_Potion,ETriggerEvent::Started,this,&ThisClass::Input_PickUpPotionStarted);
...
void AWarriorHeroCharacter::Input_PickUpPotionStarted(const FInputActionValue& InputActionValue)
{	
	FGameplayEventData Data;

	UAbilitySystemBlueprintLibrary::SendGameplayEventToActor(
		this,
		WarriorGameplayTags::Player_Event_ConsumePotion,
		Data
	);
}
